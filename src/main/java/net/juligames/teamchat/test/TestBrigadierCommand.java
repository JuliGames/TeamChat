package net.juligames.teamchat.test;
...
/**
 * Copied from <a href="https://docs.papermc.io/velocity">Velocity Documentation</a>
 */

public final class TestBrigadierCommand {

    public static @NotNull BrigadierCommand createBrigadierCommand(final ProxyServer proxy) {
